...
\restrict TfUibBNtpbraDIS7UFS8Kot6B108Zhgpj8Q7D0BRnRqaxZTlQBJf1EaX7SWTJae
...
CREATE TABLE public.comments_comment (
    ...
    CONSTRAINT comments_comment_level_check CHECK ((level >= 0)),
    CONSTRAINT comments_comment_lft_check CHECK ((lft >= 0)),
    CONSTRAINT comments_comment_rght_check CHECK ((rght >= 0)),
    CONSTRAINT comments_comment_tree_id_check CHECK ((tree_id >= 0))
);
...
--
-- Name: comments_comment_tree_id_d91ce17d; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX comments_comment_tree_id_d91ce17d ON public.comments_comment USING btree (tree_id);
...
\unrestrict TfUibBNtpbraDIS7UFS8Kot6B108Zhgpj8Q7D0BRnRqaxZTlQBJf1EaX7SWTJae
